...
object RulesEngine {
  ...
  def main(args: Array[String]) {
    ...
    val inputf = sc.textFile("output_ont\\Triplets", 4)
    ...
    trip1.foreach( t1 =>
    {
      trip2.foreach( t2 => {
        if (t1(2).equals(t2(0))   && t1(1).equals(t2(1)) &&  !t1(2).equals(t2(2))) {
          //println(t1(0) + " " + t1(1) + " " + t1(2) + " inverse to " + t2(0) + " " + t2(1) + " " + t2(2))
          pw.println(t1(0) + "," + t1(1) + "," + t1(2) +" and ")
          pw.println(t2(0) + "," + t2(1) + "," + t2(2) )
          pw.println("Transtive :" )
          pw.println(t1(0) + "," + t1(1) + "," + t2(2) )
          //println("\n")
        }
      })
    })
        ...
        if (t1(2).equals(t2(0))   && t1(1).equals(t2(1)) &&  !t1(2).equals(t2(2))) {
          trip3.foreach(t3 => {
            if (t1(0).equals(t3(0)) && t2(2).equals(t3(2)) && !t1(1).equals(t3(1)) ) {
              pw.println(t1(0) + "," + t1(1) + "," + t1(2) )
              pw.println(t2(0) + "," + t2(1) + "," + t2(2) )
              pw.println("property axiom :" )
              pw.println(t3(0) + "," + t3(1) + "," + t3(2) )
              //pw.write("\n")
            }
          }
          )
